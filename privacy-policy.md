...
- The mobile phone number used to send the message
- The content of messages sent to and from this number
- Timestamps of messages

## How we use this information
Message content and sender phone numbers are used solely to create and maintain an internal log of missed rental opportunities for business reporting purposes. Phone numbers are matched against a pre-approved internal list of employees; messages from unrecognized numbers are not logged.

## Sharing of information
We do not sell, rent, or share message content or phone numbers with third parties for marketing purposes. Message data is stored using our internal business systems (including cloud hosting and data-processing providers acting on our behalf) solely to operate this program.
